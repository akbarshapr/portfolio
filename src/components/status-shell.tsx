...
// Shared frame for the 404 and error screens. No "use client" on purpose: it
// holds no state, so not-found.tsx renders it on the server while error.tsx
// pulls it into the client graph.
